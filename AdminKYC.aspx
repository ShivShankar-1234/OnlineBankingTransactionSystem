<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminKYC.aspx.cs"
    ...
    <head runat="server">
        ...
        <title>KYC Requests — NeoBank Admin</title>
                ...
                <div class="main">
                    <header class="topbar">
                        ...
                        <div class="topbar-right">
                            <span class="pending-count">⏳ Pending Review</span>
                    ...
                    <div class="main-body">
                        ...
                        <div class="filter-bar">
                            ...
                            <button class="filter-chip active" type="button">All Requests</button>
                            <button class="filter-chip" type="button">⏳ Pending</button>
                            <button class="filter-chip" type="button">✅ Verified</button>
                        ...
                        <div class="table-card">
                            <div class="table-header">
                                <div>
                                    ...
                                    <div class="table-desc">Review and approve or reject each customer's KYC submission
                                    </div>
                                </div>
                            </div>

                            <asp:GridView ID="gvKYC" runat="server" AutoGenerateColumns="False" CssClass="admin-grid"
                                Width="100%" OnRowCommand="gvKYC_RowCommand" GridLines="None">
                                <Columns>
                                    <asp:BoundField DataField="UserID" HeaderText="User ID" />
                                    <asp:BoundField DataField="AadhaarNumber" HeaderText="Aadhaar No." />
                                    <asp:BoundField DataField="PANNumber" HeaderText="PAN No." />
                                    <asp:TemplateField HeaderText="KYC Status">
                                        <ItemTemplate>
                                            <span class='kyc-status <%# Eval("KYCStatus").ToString().ToLower() %>'>
                                                <%# Eval("KYCStatus") %>
                                            </span>
                                        </ItemTemplate>
                                    </asp:TemplateField>
